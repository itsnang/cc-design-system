...
import { MultiStepFormState, FormAction, FormStep, CompleteFormData } from "../lib/types"
import { personalInfoSchema, addressSchema, preferencesSchema } from "../lib/validations/form-schemas"
...
export function useMultiStepForm() {
  ...
  const validateCurrentStep = useCallback((data: Partial<CompleteFormData>): boolean => {
    try {
